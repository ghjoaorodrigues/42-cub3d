...
/*   Updated: 2025/06/10 14:28:58 by fsilva-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int keyhook(int keycode, t_game *game)
{
    ...
    if (keycode == KEY_W)
    {
        if (game->map.matrix[(int)(game->pos_y)][(int)(game->pos_x + game->dir_x * MOVE_SPEED)] != '1')
            game->pos_x += game->dir_x * MOVE_SPEED;
        if (game->map.matrix[(int)(game->pos_y + game->dir_y * MOVE_SPEED)][(int)(game->pos_x)] != '1')
